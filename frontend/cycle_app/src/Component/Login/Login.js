                ...
                <div className="signup-form">
                  ...
                  <form className="register-form" id="register-form">
                    ...
                    <div className="form-group">
                      ...
                      <input type="email" name="email" pattern=".+@IITBHU.ac.in" id="email" placeholder="Your Email" value={this.state.emailUserRegister} onChange={(e) => {
              ...
              <div className="signup-content">
                <div className="signup-form">
                  ...
                  <form className="register-form" id="register-form">
                    ...
                    <div className="form-group">
                      <label htmlFor="email"><i className="zmdi zmdi-email" /></label>
                      <input type="email" name="email" pattern=".+@IITBHU.ac.in" id="email" placeholder="Your Email" value={this.state.emailDealerRegister} onChange={(e) => {
